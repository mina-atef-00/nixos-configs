...
let
  ...
  # Get dms-shell from unstable
  dms-shell = pkgs-unstable.dms-shell;
...
in
{
  ...
  # Wayland window manager (MangoWC) configuration
  wayland.windowManager = {
    mangowc = {
      ...
      autostart_sh = ''
        ...
        ${pkgs.wlsunset}/bin/wlsunset -l 30.0556 -L 31.2222 & # Cairo coordinates
